...
class BinarySearchTree {
    ...
    contains(searchVal) {
        ...
        while(curr) {
            ...
            // if (curr.data != searchVal && curr.left == null || curr.right == null) {
            //     return false;
            // }
            if (curr < searchVal) {
                curr = curr.left;
   ...
   */
    ...
    range(startNode = this.root) { 
        let minVal = this.containsRecursive(startNode);
        let maxVal = this.containsRecursive(startNode);
...
console.log(emptyTree.contains()) // false
  /* fullTree
                    root
                <-- 25 -->
              /            \
