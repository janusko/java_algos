...
class MinHeap {
    constructor() {
        /**
         * 0th index not used, so null is a placeholder. a
    ...
    extract() {
        ...
        while (this.heap[leftChildIdx] && this.heap[rightChildIdx] && (this.heap[current] > this.heap[leftChildIdx] || this.heap[current] > this.heap[rightChildIdx])) {
            if(this.heap[leftChildIdx] < this.heap[rightChildIdx]) {
                [this.heap[current], this.heap[leftChildIdx] = this.heap[leftChildIdx], this.heap[current]]
                current = leftChildIdx
            } else {
                [this.heap[current], this.heap[rightChildIdx]] = [this.heap[rightChildIdx], this.heap[current]]
